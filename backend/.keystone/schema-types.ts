...
export type ProductWhereInput = {
  ...
  readonly picture?: ProductImageWhereInput | null;
  readonly picture_is_null?: Scalars['Boolean'] | null;
};
...
export type ProductUpdateInput = {
  ...
  readonly status?: Scalars['String'] | null;
  readonly price?: Scalars['Int'] | null;
  readonly picture?: ProductImageRelateToOneInput | null;
};
...
export type ProductListTypeInfo = {
  key: 'Product';
  fields: 'id' | 'name' | 'description' | 'status' | 'price' | 'picture';
  backing: {
    readonly id: string;
    readonly name?: string | null;
